...
- This launches to the Home screen. Claude cannot tap to navigate the simulator headlessly — to verify a deeper screen, ask the user, or seed data and rely on the screenshot of what's reachable.
